...
public final class ClipboardInterface {
    ...
    public static boolean setText(CharSequence text, Context context) {
        return setText(text, context, null);
    }

    public static boolean setText(CharSequence text, Context context, StringBuffer out) {
        if (text != null) {
            try {
